...
import type { CreationRecord as _CreationRecord, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllCreationRecords(): Promise<Array<CreationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCreationRecords();
    ...
    async getUserCreationRecords(arg0: Principal): Promise<Array<CreationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCreationRecords(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCreationRecord(arg0: string, arg1: boolean, arg2: string, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCreationRecord(arg0, arg1, arg2, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CreationRecord_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CreationRecord): CreationRecord {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        thumbnailUrl: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.thumbnailUrl)),
        creativeFreedom: value.creativeFreedom,
        usable: value.usable,
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CreationRecord>): Array<CreationRecord> {
    return value.map((x)=>from_candid_CreationRecord_n4(_uploadFile, _downloadFile, x));
}
